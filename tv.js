$.ajax({
  url:
    "https://api.themoviedb.org/3/tv/popular?api_key=d642b0816f29d948f7e39b683ef3d6ef&language=en-US&page=1",
  type: "GET",
  dataType: "JSON",
      ...
      <div class="tile-body">
        <div class="tile-title">
         <span class="outer-ring">${result.results[i].vote_average *
           10}<sup>%</sup></span> 
           <div class="wrapper">
             <a class="tile-name" href="#">${
               result.results[i].name
             }</a>
             <span class="tile-date">${result.results[i].first_air_date}</span>
           </div>
      </div>
      <div class="tile-text">
